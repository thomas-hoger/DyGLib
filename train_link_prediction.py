...
if __name__ == "__main__":
    ...
    node_raw_features, edge_raw_features, full_data, train_data, val_data, test_data = get_link_prediction_data(
        dataset_name=args.dataset_name, val_ratio=args.val_ratio, test_ratio=args.test_ratio, supervised=args.supervised)
    ...
    for run in range(args.num_runs):
        ...
        args.seed = run
        args.save_model_name = f'{args.model_name}_{args.expe_name}'
        ...
        for epoch in range(args.num_epochs):
            ...
            if (epoch + 1) % args.test_interval_epochs == 0:
                ...
                plot_roc(
                    ...
                    os.path.join(save_model_folder, f"test_roc_{epoch + 1}.png")
                )
            ...
            # else : 
            #     early_stop = early_stopping.step([("val_loss", np.mean(val_losses), False)], model)
