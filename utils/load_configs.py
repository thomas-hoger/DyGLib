...
def get_link_prediction_args(is_evaluation: bool = False):
    ...
    parser.add_argument('--supervised', type=bool, action=argparse.BooleanOptionalAction, help='is it supervised learning')
    parser.add_argument('--link_pred', type=bool, action=argparse.BooleanOptionalAction, help='is it link prediction')
